...
- `game_rooms.ex`: room constructors, occupancy/open-slot helpers, readiness/status helpers, room permissions, private-room lifecycle, and room reset/clear states.
