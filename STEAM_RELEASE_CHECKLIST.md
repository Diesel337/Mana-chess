...
- [~] Desktop bridge exists. `npm run smoke:win:bridge` now verifies the packaged executable exposes `window.ManaChessDesktop`, reads desktop state/diagnostics, marks desktop mode, and records bridge IPC events.
